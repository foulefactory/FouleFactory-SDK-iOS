                ...
                completionBlock:(CompletedPostProjectsCreateProject) onCompleted
{
    ...
    [_queryBuilder appendString: @"/v1.1/projects"];
    ...
    {
        [_request setBody: [[APIHelper jsonSerialize: project] dataUsingEncoding:NSUTF8StringEncoding]]; //set request body
                ...
                completionBlock:(CompletedGetProjectsGetProjectFiles) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/v1.1/projects/{id}/urlCsvFiles"];
                ...
                completionBlock:(CompletedGetProjectsGetProjectTaskLines) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/v1.1/projects/{id}/taskLines"];
                ...
                completionBlock:(CompletedGetProjectsGetProjectTasks) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/v1.1/projects/{id}/tasks"];
                ...
                completionBlock:(CompletedGetProjectsGet) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/v1.1/projects/{id}"];
